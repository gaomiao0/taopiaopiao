<template>
    <div class="tqvideoThree" v-show="ischeck==2">
        <div class="tqvideoOneBox">
            <video controls  poster="../../assets/img/tqv-bg1.png">
                <source src="//cloud.video.taobao.com/play/u/1745440806/p/2/e/6/t/1/50270450359.mp4"/>>
            </video>
        ...
        <div class="tqvideoOneBox">
            <video controls poster="../../assets/img/tqv-bg1.png">
                <source src="//cloud.video.taobao.com/play/u/1745440806/p/2/e/6/t/1/50273738030.mp4"/>>
            </video>
            <p class="tqvIntroduce">一部国产良心鬼怪电影，把中国捉妖术演活了，堪称神来之笔</p>
            <div class="tqvMessage box">
                <div class="tqvSource box">
